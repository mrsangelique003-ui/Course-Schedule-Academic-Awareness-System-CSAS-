        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Department = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false, defaultValue: "CIS"),
                    StudySession = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false, defaultValue: "Day"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProcessingDays = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Purpose = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, defaultValue: "Login"),
                    ExpiresAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsUsed = table.Column<bool>(type: "bit", nullable: false),
                    UsedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    FailedAttempts = table.Column<int>(type: "int", nullable: false),
                    DeliveryChannel = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WhatsAppGroupLink = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClassRepresentatives", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClassRepresentatives_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ClassRepresentatives_Courses_CourseId",
                        column: x => x.CourseId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IssueType = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false, defaultValue: "Absent"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AttendanceFlags_AspNetUsers_RaisedByUserId",
                        column: x => x.RaisedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AttendanceFlags_ScheduleEntries_ScheduleEntryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttendanceStatus = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false, defaultValue: "Present"),
                    OfficialReason = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MakeUpRequested = table.Column<bool>(type: "bit", nullable: false),
                    MakeUpScheduledAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    RecordedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LecturerAttendances", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LecturerAttendances_Lecturers_LecturerId",
                        column: x => x.LecturerId,
                        principalTable: "Lecturers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LecturerAttendances_ScheduleEntries_ScheduleEntryId",
                        column: x => x.ScheduleEntryId,
                        principalTable: "ScheduleEntries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ScheduleEntryId = table.Column<int>(type: "int", nullable: false),
                    OriginalRoomId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RoomShifts_AspNetUsers_CreatedByUserId",
                        column: x => x.CreatedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RoomShifts_Rooms_NewRoomId",
                        column: x => x.NewRoomId,
                        principalTable: "Rooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RoomShifts_Rooms_OriginalRoomId",
                        column: x => x.OriginalRoomId,
                        principalTable: "Rooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RoomShifts_ScheduleEntries_ScheduleEntryId",
                        column: x => x.ScheduleEntryId,
                        principalTable: "ScheduleEntries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceFlags_RaisedByUserId",
                table: "AttendanceFlags",
                column: "RaisedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_AttendanceFlags_ScheduleEntryId",
                table: "AttendanceFlags",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClassRepresentatives_CourseId",
                table: "ClassRepresentatives",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_ClassRepresentatives_UserId",
                table: "ClassRepresentatives",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LecturerAttendances_LecturerId",
                table: "LecturerAttendances",
                column: "LecturerId");

            migrationBuilder.CreateIndex(
                name: "IX_LecturerAttendances_ScheduleEntryId",
                table: "LecturerAttendances",
                column: "ScheduleEntryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomShifts_CreatedByUserId",
                table: "RoomShifts",
                column: "CreatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_RoomShifts_NewRoomId",
                table: "RoomShifts",
                column: "NewRoomId");

            migrationBuilder.CreateIndex(
                name: "IX_RoomShifts_OriginalRoomId",
                table: "RoomShifts",
                column: "OriginalRoomId");

            migrationBuilder.CreateIndex(
                name: "IX_RoomShifts_ScheduleEntryId",
                table: "RoomShifts",
                column: "ScheduleEntryId");
