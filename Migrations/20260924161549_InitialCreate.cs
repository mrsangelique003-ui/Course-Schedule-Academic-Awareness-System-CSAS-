    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ClassRepresentativesId = table.Column<int>(type: "int", nullable: false),
                    RepresentedCoursesId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseClassRepresentatives", x => new { x.ClassRepresentativesId, x.RepresentedCoursesId });
                    table.ForeignKey(
                        name: "FK_CourseClassRepresentatives_ClassRepresentatives_ClassRepresentativesId",
                        column: x => x.ClassRepresentativesId,
                        principalTable: "ClassRepresentatives",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseClassRepresentatives_Courses_RepresentedCoursesId",
                        column: x => x.RepresentedCoursesId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ScheduleEntries_Administrators_AdministratorId",
                        column: x => x.AdministratorId,
                        principalTable: "Administrators",
                        principalColumn: "Id");
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ScheduleEntries_Lecturers_LecturerId",
                        column: x => x.LecturerId,
                        principalTable: "Lecturers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Administrators_StaffId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rooms_Building_RoomNumber",
                table: "Rooms",
